 ...
 public class EdgeWeightedGraph {
    ...
    public boolean isContracted(Vertex v) {
     ...
     public void writeEdge(String edgeAsString){
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/frederikkolbel/ITU/Third semester/Applied Algorithms/Hand-ins/Hand-in_3/Git folder/AppliedAlgorithmsAssignment3/EfficientRoutePlanningContraction/app/src/main/resources/shortcuts3.graph", true))) {
