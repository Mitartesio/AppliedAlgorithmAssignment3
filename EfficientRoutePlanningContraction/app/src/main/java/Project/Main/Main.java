...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        InputStream inputStreamTest = Main.class.getResourceAsStream("/denmark.graph"); ///Small_graph_for_test.graph /denmark.graph
                ...
                DijkstraUndirectedSP spGraph = new DijkstraUndirectedSP(graphResultTest.getGraph());
                ...
                scanner. close();
                    ...
                    //Bidijkstra run
                BidirectionalDijkstra spGraph = new BidirectionalDijkstra(graphResultTest.getGraph());
                Scanner scanner = new Scanner(System.in);
                while (scanner.hasNextInt()) {
                    int startNode = scanner.nextInt();
                    int endNode = scanner.nextInt();
        ...
        //I think below should just be deleted
